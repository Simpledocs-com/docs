...
Supporting documents are additional files attached to a request alongside the main legal document. You can attach files in any format (PDF, Word, images, spreadsheets, etc.), up to **200 MB per file**.
...
- `support_documents[]` accepts one or more file uploads (any format, max 200 MB each).
